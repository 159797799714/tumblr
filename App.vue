<script>
	...
	export default {
		globalData: {
			...
			//http_url: 'https://api.dapperlb.com',
			http_url: 'https://api.tokopedia-sa.com',
			// http_url: 'http://45.113.110.66',
			// http_url: 'https://api.wananapp.com',
			/** 静态文件存放地址 */
			// static_url: 'https://api.kuailiao.top',
			// static_url: 'http://45.113.110.66',
			//static_url: 'https://api.dapperlb.com',
			static_url: 'https://api.tokopedia-sa.com',
			...
			//socket_url: 'wss://api.dapperlb.com/ws',
			socket_url: 'wss://api.tokopedia-sa.com/ws',
   ...
   //          const xinstall = uni.requireNativePlugin('xinstall-plugin');
			...
			// 	        // 根据获取到的数据做对应业务逻辑
			// 	        //保存channelCode
			// 	        _data.localData('xInstallChannelCode', channelCode)
			// 	    }
			// 	});
			// }
		},
