<template>
	<view class="page">
		...
		<view class="uni-card border-top">
			<view class="uni-list">
				<view class="uni-list-cell" hover-class="none">
					<view class="uni-list-cell-navigate">
						<view style="width:100%;">
		...
		<view v-if="my.is_friend">
			<button class="sendmsg" @tap="goMsg()">发消息</button>
		</view>
		<view v-else>
			<button class="sendmsg" @tap="addFriend()" v-if="userinfo.user_info.friend_status == 1">添加到通讯录</button>
		</view>
	</view>
</template>
