	...
	<view class="page" style="overflow: hidden;">
		...
		<view class="page-content">
						...
						<block v-if="row.type==0">
							...
							<view class="other" v-if="row.msg.user_info.uid != my_data.id">
								...
								<view class="right"
									...
									<view v-if="row.msg.type==9" class="bubble img">
										<image src="/static/theme/default/chuoyichuo.gif" :lazy-load="true"
											style="height: 70px;wdith:130px" mode="heightFix" />
									</view>
									<!-- 位置-->
									<view v-if="row.msg.type==10" class="bubble" @tap="openMap(row.msg.content)">
										<view class="address-flex">
			...
			<view class="popup-layer" :class="popupLayerClass" @touchmove.stop.prevent="discard">
				...
				<!-- 更多功能 相册-拍照-红包 -->
				<swiper class="more-layer" :class="{hidden:hideMore}" duration="150">
					<swiper-item>
						<view class="list">
							...
							<view class="list-box" @tap="handRedEnvelopes">
								<image class="fun-icon" src="../../static/theme/default/RedEnvelopes.png"
									mode="heightFix">
								</image>
						...
						<view class="list" style="margin-top: 8upx;">
							<view class="list-box" @tap="chooseCard">
								<image class="fun-icon" src="../../static/theme/default/business-card.png"
									mode="heightFix">
								</image>
							...
							<view class="list-box" @tap="sendPos">
								<image class="fun-icon" src="../../static/theme/default/position.png" mode="heightFix">
								</image>
							...
							<view class="list-box" @tap="videoCall(2)" v-if="msgList.type == 0">
								<image class="fun-icon" src="../../static/theme/default/voice-input.png"
									mode="heightFix">
					...
					<swiper-item>
						<view class="list">
							<view class="list-box" @tap="chooseChuo">
								<image class="fun-icon" src="../../static/theme/default/chuo.png" mode="heightFix">
								</image>
								<view class="tool_text">戳一戳</view>
							</view>
							<view class="list-box" @tap="chooseLike">
								<image class="fun-icon" src="../../static/theme/default/my-collection.png"
									mode="heightFix">
								</image>
								<view class="tool_text">收藏</view>
							</view>
							<view class="list-box" @tap="chooseFile">
								<image class="fun-icon" src="../../static/theme/default/file.png" mode="heightFix">
								</image>
...
<script>
	...
	export default {
		...
		onShow() {
			...
			_this.getReadTime();
			setInterval(() => {
				this.nowReadTime = uni.getStorageSync(_this.list_id + '_time');
			}, 1000)
