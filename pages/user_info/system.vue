<template>
	<view style="width: 100%;">
		<view class="center" style="width: 100%;margin-top: 80rpx;">
			...
			<view style="margin-top: 20rpx;font-size: 40rpx;">默聊</view>
			<view style="margin-top: 20rpx;font-size: 20rpx;color: #CCCCCC;">版本号 v1.0.5</view>
		</view>
		<view class='personal-data'>
			<view class='list' style="margin-top: 60rpx;">
				<view class='item acea-row row-between-wrapper'>
					
					<view class="input" @click="gohtml('https://moliaocms.com')"> 
					<view>隐私政策</view>
					</view>
				</view>
				<view class='item acea-row row-between-wrapper'>
			...
			<view class='list' style="margin-top: 20rpx;">
				<view class='item acea-row row-between-wrapper'>
					<view>官方电话</view>
					<view class="input" @click="tel('059523505000')">
						0595-23505000<text class="iconfont icon-xiangyou"></text>
					</view>
				</view>
				<view class='item acea-row row-between-wrapper'>
					<view>官方网址</view>
		...
		<view style="width: 100%;padding:100rpx 40rpx;" class="center">
			<view style="margin-top: 18rpx;font-size: 20rpx;color: #333333;text-align: center;" class="center">
			Copyright © 2022 xxxx 版权所有
			</view>
			<view style="margin-top: 18rpx;font-size: 20rpx;color: #333333;text-align: center;" class="center" @click="gohtml('https://beian.miit.gov.cn/')">
				 闽ICP备20004518号-x
			</view>
		</view>
